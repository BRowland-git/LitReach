...
pub.vid <- system.file("www", "PubMed.mp4", package = "LitReach")
pop.vid <- system.file("www", "PoP.mp4", package = "LitReach")
sco.vid <- system.file("www", "Scopus.mp4", package = "LitReach")
wos.vid <- system.file("www", "Web of Science.mp4", package = "LitReach")

addResourcePath("media", dirname(pub.vid))
addResourcePath("media", dirname(pop.vid))
addResourcePath("media", dirname(sco.vid))
addResourcePath("media", dirname(wos.vid))
      ...
      tabItem(
        ...
        fluidRow(
          column(12, h3("Data Tidying Instructions"),
                 ...
                 bsModal("PubMedVid", "Watch the PubMed Guide", "PubMed", size = "large", tags$video(src = "media/PubMed.mp4", height = "900", width = "100%", type = "video/mp4",  controls = TRUE), tags$body(p("PubMed:"),
                 ...
                 bsModal("ScoVid", "Watch the Scopus Guide", "Scopus", size = "large", tags$video(src = "media/Scopus.mp4", height = "900", width = "100%", type = "video/mp4",  controls = TRUE), tags$body(p("Scopus:"),
                 ...
                 bsModal("WoSVid", "Watch the Web of Science Guide", "WebofScience", size = "large", tags$video(src = "media/Web of Science.mp4", height = "900", width = "100%", type = "video/mp4",  controls = TRUE),tags$body(p("Web of Science:"),
                                                                                                                                                                                       p("1. On the search page for your selected article, press on the number of citations for the article"),
                 ...
                 bsModal("PoPVid", "Watch the Publish or Perish Guide", "PoP", size = "large", tags$video(src = "media/Pop.mp4", height = "900", width = "100%", type = "video/mp4",  controls = TRUE),tags$body(p("Publish or Perish:"),
      ...
      tabItem(
        ...
        fluidRow(
          ...
          column(4,
                 ...
                 p("Duplicate references were removed from the data by removing exact matches between author, title and the iid project being referenced. Further duplicates
                   were removed if the reference title had 15 or fewer characters different to another title.", style = "font-size:16px"),
                 br(),
                 p(strong("How was the country associated with each piece of literaure decided?"), style = "font-size:18px"),
                 p("The country associated with each piece of literature was determined based on the country of affiliation for the first author.",
                 ...
                 p("An article consisted of but was not limited to features, editorials and news articles.", style = "font-size:16px"),
                 br(),
                 p(strong("Why do some of the research outputs have 0 in some of the catagories?"), style = "font-size:18px"),
                 p("The research output metrics were collected from the publishers. Not all publishers collect the same metric data so the data displayed here are what was available.", style = "font-size:16px"),
                 br(),
                 p(strong("Why are there fewer boxes than the number of citations, views etc?"), style = "font-size:18px"),
