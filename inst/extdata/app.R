      ...
      tabItem(
        ...
        fluidRow(
          column(12, h3("Data Tidying Instructions"),
                 ...
                 bsModal("PubMedVid", "Watch the PubMed Guide", "PubMed", size = "large", tags$video(src = system.file("www", "PubMed.mp4", package = "LitReach"), height = "900", width = "100%", type = "video/mp4",  controls = TRUE), tags$body(p("PubMed:"),
                 ...
                 bsModal("ScoVid", "Watch the Scopus Guide", "Scopus", size = "large", tags$video(src = system.file("www", "Scopus.mp4", package = "LitReach"), height = "900", width = "100%", type = "video/mp4",  controls = TRUE), tags$body(p("Scopus:"),
                 ...
                 bsModal("WoSVid", "Watch the Web of Science Guide", "WebofScience", size = "large", tags$video(src = system.file("www", "Web of Science.mp4", package = "LitReach"), height = "900", width = "100%", type = "video/mp4",  controls = TRUE),tags$body(p("Web of Science:"),
                                                                                                                                                                                       p("1. On the search page for your selected article, press on the number of citations for the article"),
                 ...
                 bsModal("PoPVid", "Watch the Publish or Perish Guide", "PoP", size = "large", tags$video(src = system.file("www", "PoP.mp4", package = "LitReach"), height = "900", width = "100%", type = "video/mp4",  controls = TRUE),tags$body(p("Publish or Perish:"),
